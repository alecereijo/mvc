    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO usuarios (usuario, clave, novas, usuarios) VALUES ('$usuario','$clave_encriptada',$novas,$usuarios)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',novas=$novas,usuarios=$usuarios WHERE id='$id'") :
